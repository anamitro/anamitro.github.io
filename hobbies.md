...
<div style="position: relative; display: inline-block; color: white;">
  ...
  <div style="position: absolute; top: 50%; left: 10%; transform: translate(-50%, -50%); font-size: 24px; font-weight: bold; text-shadow: 48px 48px 48px rgba(0,0,0,0.5);">
   ...
   <div style="position: absolute; top: 60%; left: 10%; transform: translate(-50%, -50%); font-size: 12px; text-shadow: 24px 24px 24px rgba(0,0,0,0.5);">
  ...
  <div style="position: absolute; top: 60%; left: 90%; transform: translate(-50%, -50%); font-size: 12px;; text-shadow: 2px 2px 4px rgba(0,0,0,0.5);">
